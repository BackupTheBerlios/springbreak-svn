...
// $Id: ChannelBuilderIF.java,v 1.13 2004/01/30 20:36:05 niko_schmuck Exp $
...
public interface ChannelBuilderIF {
	 ...
	 */
	ItemIF createItem(ChannelIF channel, String title, String description,
			URL link);

	ItemIF createItem(Element itemElement, ChannelIF channel, String title,
